...
public class Lab3_Week8 
{
	...
	public static void main(String[] args)
	{
		...
		else
		{
			...
			JOptionPane.showMessageDialog(null, String.format("You have %d years, %d months, and %d days until you can legally drink alcohol.", yearsUntil, monthsUntil, daysUntil));
		}
	}
}
